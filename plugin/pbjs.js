...
exports.main = function main(args, callback) {
    ...
    var argv = minimist(args, {
        ...
        boolean: [ "create", "encode", "decode", "verify", "convert", "delimited", "beautify", "comments", "es6", "sparse", "keep-case", "force-long", "force-number", "force-enum-string", "force-message","alternate-comment" ],
        default: {
            target: "json",
            create: true,
            encode: true,
    ...
    if (!files.length) {
        ...
        if (callback)
            ...
            process.stderr.write([
                ...
                "  --alternate-comment alternate comment parsing: \"//\" or \"/*\"",
                "",
    ...
    var parseOptions = {
        ...
        "alternateCommentMode":argv["alternate-comment"] || false
    };
